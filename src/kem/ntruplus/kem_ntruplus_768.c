...
OQS_KEM *OQS_KEM_ntruplus_768_new(void) {
    ...
    kem->keypair_derand = OQS_KEM_ntruplus_768_keypair_derand;
...
OQS_API OQS_STATUS OQS_KEM_ntruplus_768_decaps(uint8_t *shared_secret, const unsigned char *ciphertext, const uint8_t *secret_key) {
