...
* Returns 0 (success)
**************************************************/
int ntruplus_kem768_crypto_kem_keypair(unsigned char *pk, unsigned char *sk)
{
...
* Returns 0 (success)
**************************************************/
int ntruplus_kem768_crypto_kem_enc(unsigned char *ct,
                   unsigned char *ss,
...
**************************************************/
int ntruplus_kem768_crypto_kem_dec(unsigned char *ss,
