...
OQS_KEM *OQS_KEM_ntruplus_864_new(void) {
	...
	kem->length_public_key = OQS_KEM_ntruplus_864_length_public_key;
	kem->length_secret_key = OQS_KEM_ntruplus_864_length_secret_key;
	kem->length_ciphertext = OQS_KEM_ntruplus_864_length_ciphertext;
    kem->length_shared_secret = OQS_KEM_ntruplus_864_length_shared_secret;
	kem->length_shared_secret = OQS_KEM_ntruplus_864_length_shared_secret;

	kem->keypair = OQS_KEM_ntruplus_864_keypair;
    kem->keypair_derand = OQS_KEM_ntruplus_864_keypair_derand;
	kem->encaps = OQS_KEM_ntruplus_864_encaps;
	kem->decaps = OQS_KEM_ntruplus_864_decaps;
...
OQS_API OQS_STATUS OQS_KEM_ntruplus_864_keypair_derand(uint8_t *public_key, uint8_t *secret_key, const uint8_t *seed) {
	(void)public_key;
	(void)secret_key;
	(void)seed;
	return OQS_ERROR;
...
OQS_API OQS_STATUS OQS_KEM_ntruplus_864_decaps(uint8_t *shared_secret, const unsigned char *ciphertext, const uint8_t *secret_key) {
