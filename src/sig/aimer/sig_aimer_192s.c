...
extern int samsungsds_aimer192s_ref_crypto_sign_keypair(uint8_t *pk, uint8_t *sk);
extern int samsungsds_aimer192s_ref_crypto_sign_signature(uint8_t *sig, size_t *siglen, const uint8_t *m, size_t mlen, const uint8_t *sk);
extern int samsungsds_aimer192s_ref_crypto_sign_verify(const uint8_t *sig, size_t siglen, const uint8_t *m, size_t mlen, const uint8_t *pk);

OQS_API OQS_STATUS OQS_SIG_aimer_192s_keypair(uint8_t *public_key, uint8_t *secret_key) {
	return (OQS_STATUS) samsungsds_aimer192s_ref_crypto_sign_keypair(public_key, secret_key);
}
...
OQS_API OQS_STATUS OQS_SIG_aimer_192s_sign(uint8_t *signature, size_t *signature_len, const uint8_t *message, size_t message_len, const uint8_t *secret_key) {
	return (OQS_STATUS) samsungsds_aimer192s_ref_crypto_sign_signature(signature, signature_len, message, message_len, secret_key);
}
...
OQS_API OQS_STATUS OQS_SIG_aimer_192s_verify(const uint8_t *message, size_t message_len, const uint8_t *signature, size_t signature_len, const uint8_t *public_key) {
	return (OQS_STATUS) samsungsds_aimer192s_ref_crypto_sign_verify(signature, signature_len, message, message_len, public_key);
}
