...
OQS_SIG *OQS_SIG_aimer_128f_ref_new(void) {
	...
	sig->method_name = OQS_SIG_alg_aimer_128f_ref;
	...
	sig->length_public_key = OQS_SIG_aimer_128f_ref_length_public_key;
	sig->length_secret_key = OQS_SIG_aimer_128f_ref_length_secret_key;
	sig->length_signature = OQS_SIG_aimer_128f_ref_length_signature;

	sig->keypair = OQS_SIG_aimer_128f_ref_keypair;
	sig->sign = OQS_SIG_aimer_128f_ref_sign;
	sig->verify = OQS_SIG_aimer_128f_ref_verify;
