...
OQS_API const char *OQS_SIG_alg_identifier(size_t i) {
	...
	const char *a[OQS_SIG_algs_length] = {
		...
		OQS_SIG_alg_aimer_128f_ref,
		OQS_SIG_alg_aimer_192f_ref,
...
OQS_API int OQS_SIG_alg_is_enabled(const char *method_name) {
	...
	if (0) {
		...
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_aimer_128f_ref)) {
#ifdef OQS_ENABLE_SIG_aimer_128f_ref
		return 1;
#else
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_aimer_192f_ref)) {
...
#ifdef OQS_ENABLE_SIG_aimer_128f_ref
		return OQS_SIG_aimer_128f_ref_new();
#else
		return NULL;
#endif
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_aimer_192f_ref)) {
#ifdef OQS_ENABLE_SIG_aimer_192f_ref
		return OQS_SIG_aimer_192f_ref_new();
#else
		return NULL;
#endif
